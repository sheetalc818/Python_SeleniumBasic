...
actions.move_to_element(establish)\
    .move_to_element(apprentices)\
    .move_to_element(BTP).move_to_element(verification)\
    .move_to_element(TPA).move_to_element(app_act).move_to_element(goto).click().perform()
